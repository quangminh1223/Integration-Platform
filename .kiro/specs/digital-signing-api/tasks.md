...
- [ ] 1. Set up D-Sign module structure and core interfaces
  - [x] 1.1 Create Maven module and base configuration
  ...
  - [x] 1.2 Define exception hierarchy and global error handler
  ...
  - [x] 1.3 Define DTOs (request and response)
  ...
  - [x] 1.4 Define domain entities and repositories
  ...
  - [x] 1.5 Define core interfaces (HsmAdapter, CaProvider)
...
- [ ] 2. Implement HSM adapter and connection pool
  - [x] 2.1 Implement HsmConnectionPool
...
- [ ] 3. Implement CA provider integration
  - [x] 3.1 Implement CaProviderRegistry and base CA provider
  ...
  - [x] 3.2 Implement OCSP and CRL validators
