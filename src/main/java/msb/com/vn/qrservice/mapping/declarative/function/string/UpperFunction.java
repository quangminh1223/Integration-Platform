...
/** {@code UPPER(str)} — chuyển toàn bộ ký tự thành hoa. Null vào → null ra. */
@Component
public class UpperFunction implements TransformFunction {
    ...
    public JsonNode apply(List<JsonNode> args) {
        ...
        return JsonNodeFactory.instance.textNode(value.asText().toUpperCase());
    }
}
